from mcp_integration.filesystem_client import get_filesystem_tools, execute_filesystem_tool
from mcp_integration.github_client import get_github_tools, execute_github_tool
from mcp_integration.playwright_client import get_playwright_tools, execute_playwright_tool
...
class MCPRegistry:
    ...
    def registered_server(self) -> list[str]:
